...
export const ChangeTab: React.FC<ChangeTabProps> = ({
  original,
  setOriginal,
  newValue,
  setNewValue,
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="space-y-1.5">
        ...
        />
        <p className="text-[11px] text-slate-400">The initial reference amount</p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full text-sm font-semibold bg-slate-50 dark:bg-slate-900/80 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 rounded-xl px-3.5 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-600"
        />
        <p className="text-[11px] text-slate-400">The resulting final value</p>
      </div>
    </div>
  );
};
