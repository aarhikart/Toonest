...
import { CalculationHistoryItem } from '@/lib/percentage/types';
          ...
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 max-w-xs">
                  Your calculations will appear here as you use the calculator.
                </p>
              </div>
            </div>
          ) : (
            items.map((item) => (
              ...
              >
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400 font-mono text-[11px] truncate">
                  {item.formula}
                </div>
