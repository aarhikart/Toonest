...
import { PdfToJpgHero } from '@/components/pdfToJpg/PdfToJpgHero';
...
import { PdfToJpgSEO } from '@/components/pdfToJpg/PdfToJpgSEO';
import { PdfToJpgFAQ } from '@/components/pdfToJpg/PdfToJpgFAQ';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-50/50 dark:bg-[#0c0e14] text-zinc-900 dark:text-zinc-100 transition-colors">
      ...
      <Header
        ...
        activeToolName="PDF to JPG Converter"
      />
          ...
          <div className="space-y-6 max-w-3xl mx-auto py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 text-center text-xs text-zinc-600 dark:text-zinc-400">
              <div className="p-4 rounded-2xl bg-white dark:bg-zinc-900/70 border border-zinc-200/80 dark:border-zinc-800 space-y-1 shadow-xs">
                <div className="font-bold text-zinc-900 dark:text-white">Full Page Previews</div>
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
                  Inspect page thumbnails, reorder sequences, and pick exact ranges.
                </p>
              </div>
              <div className="p-4 rounded-2xl bg-white dark:bg-zinc-900/70 border border-zinc-200/80 dark:border-zinc-800 space-y-1 shadow-xs">
                <div className="font-bold text-zinc-900 dark:text-white">Print-Quality DPI</div>
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
                  Choose 72, 150, 300 DPI or custom resolution with 1-100% JPG quality.
                </p>
              </div>
              <div className="p-4 rounded-2xl bg-white dark:bg-zinc-900/70 border border-zinc-200/80 dark:border-zinc-800 space-y-1 shadow-xs">
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Every PDF document is rendered directly inside your browser using Mozilla PDF.js and HTML5 Canvas. Your confidential contracts, invoices, and sensitive documents never touch a third-party server.
            </p>
          </div>
        </section>

        {/* Detailed SEO Sections (Sections 40 - 41) */}
        <PdfToJpgSEO />

        {/* Comprehensive FAQ Section (Section 42) */}
        <div id="faq-section">
          <PdfToJpgFAQ />
        </div>
      </main>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-2xl max-w-lg w-full p-6 sm:p-7 space-y-5 animate-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800">
              <div className="flex items-center gap-2 text-zinc-900 dark:text-white font-bold text-base">
                ...
                <span>PDF to JPG Converter Guide</span>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-4 text-xs sm:text-sm text-zinc-600 dark:text-zinc-300">
              <div className="space-y-1">
                ...
                <ol className="list-decimal list-inside space-y-1 text-zinc-500 dark:text-zinc-400">
                  ...
                  <li>Configure DPI (150 DPI recommended for screens, 300 DPI for print) and JPG quality.</li>
                  <li>Click &quot;Convert to JPG&quot; and download single images or the full ZIP package.</li>
                </ol>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-purple-50 dark:bg-purple-950/30 border border-[#5722AF]/20 text-xs text-[#5722AF] dark:text-[#9B6BE8] space-y-1">
                <div className="font-bold">Pro Tip: Custom Range Syntax</div>
                <p>
                  You can specify comma-separated single pages and hyphenated spans, such as <code className="font-mono font-bold">1-4, 7, 10-12</code>.
                </p>
              </div>
            </div>
