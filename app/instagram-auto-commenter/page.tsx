...
import { CommentAssistantTool } from '@/components/instagram-comment/CommentAssistantTool';

export default function InstagramAutoCommenterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-50 dark:bg-[#0c0e14] text-zinc-900 dark:text-zinc-100 transition-colors">
      {/* Global Header */}
      <Header
        activeToolName="Instagram Auto Commenter"
      ...
      <Sidebar
        ...
        activeToolId="instagram-auto-commenter"
        onOpenHelp={() => {
